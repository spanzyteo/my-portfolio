...
export const projects = [
  ...
  },
  {
    ...
    image: doughnation,
    description:
      "Built a full-stack donation platform leveraging Supabase-hosted PostgreSQL for scalable data storage, Prisma ORM for database management, and an Express.js backend containerized with Docker. The frontend, developed in Next.js with Tailwind CSS, features an engaging and responsive UI with smooth animations. Integrated secure authentication, real-time data handling, and optimized API performance to ensure a seamless donation experience.",
